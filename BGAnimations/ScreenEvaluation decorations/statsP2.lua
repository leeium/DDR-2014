...
t[#t+1] = LoadFont("Common Normal")..{
	InitCommand=cmd(player,PLAYER_2;zoom,1;draworder,6;y,SCREEN_CENTER_Y-175;horizalign,right;addx,15);
...
--Marvelous--
t[#t+1] = LoadFont("Common Normal")..{
	InitCommand=cmd(player,PLAYER_2;zoom,0.72;draworder,5;y,SCREEN_TOP+217;horizalign,right);
	OnCommand=function(self)
...
--Perfect--
t[#t+1] = LoadFont("Common Normal")..{
	InitCommand=cmd(player,PLAYER_2;zoom,0.72;draworder,5;y,SCREEN_TOP+242;horizalign,right);
	OnCommand=function(self)
...
--Great--
t[#t+1] = LoadFont("Common Normal")..{
	InitCommand=cmd(player,PLAYER_2;zoom,0.72;draworder,5;y,SCREEN_TOP+267;horizalign,right);
	OnCommand=function(self)
		self:settextf(Great);
		self:diffuse(color("#000000"));
	end;
...
--Good--
t[#t+1] = LoadFont("Common Normal")..{
	InitCommand=cmd(player,PLAYER_2;zoom,0.72;draworder,5;y,SCREEN_TOP+292;horizalign,right);
	OnCommand=function(self)
		self:settextf(Good);
		self:diffuse(color("#000000"));
	end;
...
--Ok--
t[#t+1] = LoadFont("Common Normal")..{
	InitCommand=cmd(player,PLAYER_2;zoom,0.72;draworder,5;y,SCREEN_TOP+317;horizalign,right);
	OnCommand=function(self)
		self:settextf(Ok);
		self:diffuse(color("#000000"));
	end;
...
--Miss--(Almost+Miss)
t[#t+1] = LoadFont("Common Normal")..{
	InitCommand=cmd(player,PLAYER_2;zoom,0.72;draworder,5;y,SCREEN_TOP+342;horizalign,right);
	OnCommand=function(self)
		self:settextf(Miss);
		self:diffuse(color("#000000"));
	end;
