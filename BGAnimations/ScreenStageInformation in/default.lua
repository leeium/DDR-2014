...
t[#t+1] = Def.ActorFrame {
	...
	---- DOOR OPEN > CLOSE  CLOSE > OPEN
		...
		InitCommand=cmd(zoomx,1.1;x,SCREEN_CENTER_X;y,0;);
		OnCommand=cmd(sleep,1.80;linear,0.45;y,-360);
	};
    ...
    LoadActor("../DDR_logo_Doors.png")..{
		...
		OnCommand=cmd(sleep,1.80;linear,0.25;diffusealpha,0);
	};
...
t[#t+1] = Def.Quad{
	OnCommand=cmd(diffuse,color("#000000");Center;setsize,464,464;diffusealpha,0;zoom,4;sleep,1.9;linear,0.2;diffusealpha,1;zoom,1);
	};
