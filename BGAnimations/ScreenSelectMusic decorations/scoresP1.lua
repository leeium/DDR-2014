...
local t=Def.ActorFrame {
	LoadFont("Common normal")..{
		InitCommand=cmd(zoom,0.8;shadowlength,2;x,SCREEN_LEFT+175-135;y,SCREEN_CENTER_Y-160-43-6.5-30+42;horizalign,left;diffuse,color("White");strokecolor,color("#000000"));
	...
	LoadFont("Common normal")..{
		InitCommand=cmd(zoom,0.8;shadowlength,2;x,SCREEN_LEFT+175+140;y,SCREEN_CENTER_Y-160-43-6.5-30+38;horizalign,right;diffuse,color("#000000");strokecolor,color("White"));
		BeginCommand=cmd(playcommand,"Set");
		SetCommand=function(self)
			local SongOrCourse, StepsOrTrail;
			if GAMESTATE:IsCourseMode() then
	...
	Def.Quad{
	InitCommand=cmd(zoom,0.4;shadowlength,2;x,SCREEN_LEFT+175+22;y,SCREEN_CENTER_Y-160-43-6.5-30+38;horizalign,center;draworder,2);
		BeginCommand=cmd(playcommand,"Set");
		SetCommand=function(self)
			local SongOrCourse, StepsOrTrail;
			if GAMESTATE:IsCourseMode() then
	...
	InitCommand=cmd(zoom,1;shadowlength,2;x,SCREEN_LEFT+175+22+14;y,SCREEN_CENTER_Y-160-43-6.5-30+30;horizalign,center;draworder,1);
		BeginCommand=cmd(playcommand,"Set");
		SetCommand=function(self)
			local SongOrCourse, StepsOrTrail;
			if GAMESTATE:IsCourseMode() then
...
t[#t+1] = LoadActor("ScoreFrame.png")..{
	InitCommand=cmd(player,PLAYER_1;vertalign,top;x,SCREEN_LEFT+175;y,SCREEN_CENTER_Y-160-43-6.5-30+20;zoom,0.7);
