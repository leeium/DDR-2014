...
t[#t+1] = LoadActor("DiffFrame.png")..{
	InitCommand=cmd(player,PLAYER_1;vertalign,top;x,SCREEN_LEFT+175+10;y,SCREEN_CENTER_Y-160-43-6.5-30+20;zoom,0.7);
	...
	t[#t+1]=Def.ActorFrame {
		...
		-- 1P Cursor
		Def.Quad{
			InitCommand = cmd(hibernate,0.7;y,100;x,-431-25+20;visible,false;setsize,438,50;zoom,0.7);
...
t[#t+1] = LoadActor("DiffTitles.png")..{
	InitCommand=cmd(player,PLAYER_1;vertalign,top;x,SCREEN_LEFT+175-9;y,SCREEN_CENTER_Y-160-43-6.5-30+20;zoom,0.7);
	OffCommand=cmd(sleep,0.15;linear,0.25;addx,-500);
	};
end;
